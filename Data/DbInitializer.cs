...
public class DbInitializer
{
    ...
    public static void SeedSong(AppDbContext context)
    {
        ...
        {
            new Song {SingerId = 1, ComposerId = 2, Title = "Bài hái 1", Lyrics = "Lời 1", ThumbnailUrl = "https://res.cloudinary.com/nguyenanhtu/image/upload/v1779880293/wo4jkq02o9cwb4ezvtvw.jpg", Mp3Link = "https://zingmp3.vn/bai-hat/Phep-Mau-From-Dan-Ca-Go-Original-Soundtrack-MAYDAYs-Minh-Toc-Lam/Z8WOE0DD.html", ReleaseDate = DateTime.Today, CreatedAt = DateTime.Today, UpdatedAt = DateTime.Today, Status = 1},
